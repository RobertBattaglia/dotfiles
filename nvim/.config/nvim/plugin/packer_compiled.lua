...
_G.packer_plugins = {
  ...
  ["bufferline.nvim"] = {
    loaded = true,
    path = "/Users/me/.local/share/nvim/site/pack/packer/start/bufferline.nvim",
  ...
  ["lsp-zero.nvim"] = {
    loaded = true,
    path = "/Users/me/.local/share/nvim/site/pack/packer/start/lsp-zero.nvim",
  ...
  ["rose-pine"] = {
    loaded = true,
    path = "/Users/me/.local/share/nvim/site/pack/packer/start/rose-pine",
  ...
  undotree = {
    loaded = true,
    path = "/Users/me/.local/share/nvim/site/pack/packer/start/undotree",
